...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
        ...
        <html>
            <head>
               ...
               <!-- <meta charset="UTF-8"/>-->
                ...
                <link rel="stylesheet" type="text/css" href="appCritOV.css"/>
            ...
            <body>
                ...
                <div id="title">
                   ...
                   <ul> 
                       ...
                       <li>
                 <xsl:for-each select="descendant::listWit/witness">
                     <span class="{@xml:id}"><xsl:apply-templates/></span>
                 </xsl:for-each>          
                       </li> 
                   </ul>      
 ...
 <div id="container">            
    ...
    <xsl:template match="app">
       <xsl:choose><xsl:when test="descendant::p"> <div class="app"><xsl:apply-templates select="rdg[@wit='#MRM-LM']"/>
           <xsl:apply-templates select="rdg[@wit='#MRM-OV']"/>
       </div></xsl:when>
       <xsl:otherwise>
           <span class="app">
               <xsl:apply-templates select="rdg[@wit='#MRM-LM']"/>
               <xsl:apply-templates select="rdg[@wit='#MRM-OV']"/>
           </span>
       </xsl:otherwise>
       </xsl:choose>
